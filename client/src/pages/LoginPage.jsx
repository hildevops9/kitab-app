  ...
  return (
    <div style={s.root} className="page-root">
      ...
      <div style={s.body}>
        ...
        <p style={s.guestNote}>Tanpa akun, feature notes dan progress belajar tidak akan tersimpan</p>

        <p style={s.footer}>
          Belum punya akun Google Mail?{' '}
...
const s = {
  root: { width: '100%', minHeight: '100dvh', background: '#FDFAF5', fontFamily: "'Nunito', sans-serif", display: 'flex', flexDirection: 'column' },
  ...
  topNav: { position: 'absolute', top: 'max(16px, env(safe-area-inset-top, 16px))', left: 0, right: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 20px', zIndex: 2 },
  backBtn: { fontSize: '13px', fontWeight: '700', color: '#1C3D2E', textDecoration: 'none', background: 'rgba(253,250,245,0.9)', borderRadius: '20px', padding: '5px 12px', backdropFilter: 'blur(4px)' },
  body: { flex: 1, padding: '32px 24px 48px', display: 'flex', flexDirection: 'column', background: '#FDFAF5' },
  titleWrap: { marginBottom: '28px' },
  title: { fontFamily: 'Lora, serif', fontSize: '26px', fontWeight: '700', color: '#1C3D2E', marginBottom: '6px' },
  subtitle: { fontSize: '14px', color: '#8A7A65', lineHeight: 1.5 },
  errorBox: { background: '#FEF2F2', border: '1px solid #FECACA', color: '#DC2626', padding: '12px 16px', borderRadius: '12px', marginBottom: '20px', fontSize: '13px', fontWeight: '600' },
  googleSection: { display: 'flex', justifyContent: 'center', marginBottom: '20px' },
  loadingBox: { display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 24px', borderRadius: '12px', border: '1.5px solid rgba(28,61,46,0.15)', background: '#fff', color: '#1C3D2E' },
  spinner: { width: '20px', height: '20px', border: '2.5px solid #E8E0D0', borderTop: '2.5px solid #1C3D2E', borderRadius: '50%', flexShrink: 0 },
  ...
  guestNote: { textAlign: 'center', fontSize: '11px', color: '#A0906E', marginBottom: '24px' },
