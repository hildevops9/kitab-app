...
const n = {
  ...
  textarea: { width:'100%', border:'1px solid #E5DDD0', borderRadius:'10px', padding:'10px 12px', fontSize:'16px', color:'#3A3A3A', lineHeight:1.8, fontFamily:"'Nunito',sans-serif", resize:'none', outline:'none', background:'#FDFAF5', display:'block', boxSizing:'border-box', WebkitTextSizeAdjust:'100%' },
...
const s = {
  root: { width:'100%', minHeight:'100dvh', background:'#F8F5EF', fontFamily:"'Nunito',sans-serif", display:'flex', flexDirection:'column', paddingTop:'calc(57px + env(safe-area-inset-top, 0px))' },
  ...
  topBar: { display:'flex', justifyContent:'space-between', alignItems:'center', padding:'16px 20px', background:'#F8F5EF', position:'fixed', top:0, left:0, right:0, zIndex:10, borderBottom:'1px solid rgba(0,0,0,0.05)' },
  ...
  contentArea: { flex:1, padding:'16px 20px 180px', marginTop:'0', display:'flex', flexDirection:'column', gap:'12px' },
  rawContent: { background:'#fff', borderRadius:'14px', padding:'16px', fontSize:'14px', color:'#3A3A3A', lineHeight:1.8 },
  bottomBar: { padding:'14px 20px', paddingBottom:'calc(14px + env(safe-area-inset-bottom, 0px))', background:'#fff', borderTop:'1px solid rgba(0,0,0,0.06)', position:'fixed', bottom:0, left:0, right:0, zIndex:10, display:'flex', flexDirection:'column', gap:'10px' },
